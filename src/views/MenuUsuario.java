...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		iniciandoMenuUsuario();
	}


	private void iniciandoMenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/resources/imagens/aH-40px.png")));
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/resources/imagens/pessoas.png")));
		...
		panelMenu.add(logo);
		logo.setIcon(new ImageIcon(MenuUsuario.class.getResource("/resources/imagens/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/resources/imagens/reservado.png")));
		...
		btnexit.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				int retornar = JOptionPane.showConfirmDialog(contentPane, "Deseja retornar ao Menu Principal?");
				if (retornar == 0) {
					MenuPrincipal menuPrincipal = new MenuPrincipal();
					menuPrincipal.setVisible(true);
					dispose();
				} else {
					JOptionPane.showMessageDialog(contentPane, "Cancelando");
				}
			}
			@Override
			public void mouseEntered(MouseEvent e) {
		...
		String textoDescripcion = "<html><body>Sistema de reservas de hotéis. Controle e gerencie de forma otimizada " +
				"e fácil <br> o fluxo de reservas e hóspedes do hotel   </body></html>";
		...
		String textoDescricao1 = "<html><body> Esta ferramenta permitirá que você mantenha um controle completo e " +
				"detalhado de suas reservas e hóspedes, você terá acesso a ferramentas especiais para " +
				"tarefas específicas como:</body></html>";
