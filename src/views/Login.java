...
public class Login extends JFrame {
	...
	public Login() {
		inicializaPanelLogin();
	}

	private void inicializaPanelLogin() {
		setResizable(false);
		setUndecorated(true);
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/resources/imagens/img-hotel-login-.png")));
		...
		logo.setIcon(new ImageIcon(Login.class.getResource("/resources/imagens/lOGO-50PX.png")));
