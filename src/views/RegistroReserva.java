...
public class RegistroReserva extends JFrame {
	...
	public RegistroReserva() {
		...
		iniciandoReservasView();
	}

	private void iniciandoReservasView() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroReserva.class.getResource("/resources/imagens/aH-40px.png")));
		...
		txtDataE.getCalendarButton().setIcon(new ImageIcon(RegistroReserva.class.getResource("/resources/imagens/icon-reservas.png")));
		...
		txtDataS.getCalendarButton().setIcon(new ImageIcon(RegistroReserva.class.getResource("/resources/imagens/icon-reservas.png")));
		...
		lblFormaPagamento.setBounds(68, 382, 213, 24);
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(RegistroReserva.class.getResource("/resources/imagens/Ha-100px.png")));

		JLabel imagemFundo = new JLabel("");
		imagemFundo.setBounds(0, 140, 500, 409);
		panel_1.add(imagemFundo);
		imagemFundo.setBackground(Color.WHITE);
		imagemFundo.setIcon(new ImageIcon(RegistroReserva.class.getResource("/resources/imagens/reservas-img-3.png")));
		...
		btnProximo.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (RegistroReserva.txtDataE.getDate() != null && RegistroReserva.txtDataS.getDate() != null) {
					salvarReserva();
				} else {
	...
	private void salvarReserva() {
		...
		JOptionPane.showMessageDialog(contentPane, "Registro salvo com sucesso! número da reserva " + novaReserva.getId().toString());
